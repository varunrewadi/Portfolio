  ...
  return (
    <div className="h-screen bg-background p-4 md:p-6 lg:p-8 overflow-hidden">
      ...
      >
        ...
        <motion.div
          className="bg-card rounded-3xl p-6 md:p-8 col-span-12 md:col-span-6 lg:col-span-6 row-span-2 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
        ...
        <motion.div
          ...
          className="bg-card rounded-3xl p-6 md:p-8 col-span-6 md:col-span-3 lg:col-span-3 row-span-2 flex items-center justify-center order-3 md:order-2 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
          variants={itemVariants}
        >
          <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-3xl" />
          <button
        ...
        {/* Projects Section */}
        <motion.div
          className="bg-card rounded-3xl p-6 md:p-8 col-span-6 md:col-span-3 lg:col-span-3 row-span-2 md:row-span-4 order-2 md:order-3 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
          variants={itemVariants}
        >
          <div className="relative z-10 flex flex-col h-full">
            <span className="text-muted-foreground uppercase text-xs md:text-sm font-medium mb-2 font-nebulica">PROJECTS</span>
        ...
        {/* Avatar Section */}
        <motion.div
          className="bg-card rounded-3xl p-6 md:p-8 col-span-6 md:col-span-3 lg:col-span-3 row-span-2 flex items-center justify-center order-4 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
          variants={itemVariants}
        >
        ...
        {/* About Section */}
        <motion.div
          className="bg-card rounded-3xl p-6 md:p-8 col-span-6 md:col-span-6 lg:col-span-6 row-span-2 order-5 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
          variants={itemVariants}
        >
          <div className="relative z-10 flex flex-col h-full">
            <span className="text-muted-foreground uppercase text-xs md:text-sm font-medium mb-2 font-nebulica">ABOUT</span>
            <h2 className="text-xl md:text-2xl lg:text-3xl text-foreground font-semibold mb-auto font-nebulica">
        ...
        {/* Newsletter Section */}
        <motion.div
          className="bg-card rounded-3xl p-6 md:p-8 col-span-12 md:col-span-6 lg:col-span-6 row-span-2 order-6 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
          variants={itemVariants}
        >
          <div className="relative z-10">
        ...
        {/* Tech Stack Section */}
        <motion.div
          className="bg-card rounded-3xl p-6 md:p-8 col-span-6 md:col-span-3 lg:col-span-3 row-span-2 order-7 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
          variants={itemVariants}
        >
          <div className="relative z-10 flex flex-col h-full">
            <span className="text-muted-foreground uppercase text-xs md:text-sm font-medium mb-3 md:mb-4 block font-nebulica">Stack I use</span>
            <div className="flex-1 flex flex-col justify-between gap-4 md:gap-6">
              ...
              <div className="h-1/2">
                <Marquee speed={40} gradient={false} className="h-full" direction="right">
                  <div className="bg-accent rounded-xl p-1.5 md:p-2 lg:p-2 flex items-center justify-center mx-1 md:mx-1.5 lg:mx-1.5">
        ...
        <motion.div
          className="bg-card rounded-3xl p-6 md:p-8 col-span-6 md:col-span-3 lg:col-span-3 row-span-2 order-8 relative group cursor-pointer transition-all duration-300 hover:bg-accent/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:border hover:border-border"
          variants={itemVariants}
        >
          <div className="relative z-10 flex flex-col h-full">
            <span className="text-muted-foreground uppercase text-xs md:text-sm font-medium mb-3 md:mb-4 block font-nebulica">Social</span>
