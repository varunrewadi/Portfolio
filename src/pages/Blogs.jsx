    ...
    <div className="min-h-screen bg-background p-4 md:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground font-nebulica mb-4">
              Blog
            </h1>
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-start gap-6">
                    <div className="flex-1">
                      ...
                      <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3 font-nebulica group-hover:text-accent transition-colors">
                        {blog.title}
                      </h2>
